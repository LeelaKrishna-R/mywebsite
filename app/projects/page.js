...
import CardParallaxThumb from "../../components/CardParallaxThumb";
import RootClient from "../../components/RootClient";

export const metadata = { title: "Projects — Leelakrishna Ravuri" };
...
export default function ProjectsPage(){
  return (
    <div>
      ...
      <main>
        <RevealOnScroll />
        <section className="reveal" style={{position:"relative",overflow:"hidden"}}>
          <SectionGraphic variant="grid" />
          <SectionGraphic variant="blob" style={{bottom:"-160px", top:"auto"}} />
          <ThreeBackground height={260} />
          <div className="container">
            <h1 className="section-title">Projects</h1>
            <p className="small muted">Click a card to flip. Only one card opens at a time.</p>
            <div className="projects">
              <ProjectCard
                ...
                links={[{label:'Repository', href:'https://github.com/LeelaKrishna-R/Dynamic-Trivia-Content-Generation'},{label:'Case study', href:'/projects/dynamic-trivia'}]}
              ...
              <ProjectCard
                ...
                links={[{label:'Code', href:'https://github.com/LeelaKrishna-R'},{label:'Case study', href:'/projects/shero'}]}
